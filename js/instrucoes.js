...
obstaculos = {
    _obs: [],
    cores: ["#ffbc1c", "#ff1c1c", "#ff851e1", "#52a7ff", "#78ff5d"],
    tempoInsere: 0,
    insere: function () {
        this._obs.push({
            x: LARGURA,
            //largura: 30 + Math.floor(21 * Math.random()), //<- isso é para ter uma largura aleatória
            largura: 50,
            altura: 30 + Math.floor(120 * Math.random()),
            cor: this.cores[Math.floor(5 * Math.random())]
        });

        //tempo que os obstáculos são inseridos
